...
//                self.navigationController?.activityStopAnimating()
//
//                let searchResultDetailVC = SearchResultsController()
//                searchResultsController.addChild(searchResultDetailVC)
//                searchResultDetailVC.view.frame = searchResultsController.view.bounds
//                searchResultsController.view.addSubview(searchResultDetailVC.view)
